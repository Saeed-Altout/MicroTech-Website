    ...
    <Section className="py-20 space-y-20" container={true}>
      ...
      <div>
        <Heading
          ...
          className="text-center mx-auto max-w-5xl"
        />
        {/* <Accordion type="single" collapsible className="mt-20 max-w-4xl mx-auto">
          <AccordionItem value="item-1">
            <AccordionTrigger>sit amet consectetur.</AccordionTrigger>
            <AccordionContent>
              Yes. Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore, voluptatibus officia blanditiis vitae ex quidem non distinctio quisquam corporis ad.
            </AccordionContent>
          </AccordionItem >
          <AccordionItem value="item-2">
            <AccordionTrigger>ccessible Lorem ipsum dolor sit.?</AccordionTrigger>
            <AccordionContent>
              Yes. It adheres to the WAI-ARIA design pattern. Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur eaque blanditiis alias?
            </AccordionContent>
          </AccordionItem>
